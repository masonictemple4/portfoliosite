...
export default function MainNav() {
  ...
  return (
      <ul className="flex flex-wrap items-center justify-center mt-4">
        <li className="mr-6"><a className="text-link-blue hover:underline underline-offset-4 hover:font-bold" href="/">home</a></li>
        ...
        <li className="mr-6"><a className="text-link-blue hover:underline underline-offset-4 hover:font-bold" href={'/resume'} target="_self">resume</a></li>
