  ...
  if (!notes) {
   ...
   return (
         <ul role="list" className="flex flex-col items-center w-full min-w-full max-w-full">
           {notes.map((note) => {
             return (
               <li className="flex items-center justify-between rounded-md border border-gray-200 py-4 pl-4 pr-5 text-sm leading-6 mb-4 w-full hover:ring hover:ring-sky-400 hover:ring-offset-emerald-600 hover:cursor-pointer hover:font-bold hover:text-lg" key={note.path}>
